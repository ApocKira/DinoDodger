...
public class PlayScene extends Application {
	 ...
	 * @author Zhiwen Yang
	 * @version 1
	 * @brief This module represents the actual game containing the selected character, landscape and obstacles
	 */
	...
	protected static boolean hasCollided = false;
	...
	/**
	 * @author Zhiwen Yang
	 * @param primaryStage Takes a Stage object upon which to set the game objects to display
	 * @throws Exception thrown for Application
	 */
	public static void startGame(Stage primaryStage) throws Exception {
		...
		//jump animation
		jumpPath = new Path();
		jumpPath.getElements().add(new MoveTo(90, 350));
		jumpPath.getElements().add(new LineTo(90, 150));
		jumpPath.getElements().add(new LineTo(90, 350));
	...
	/**
	 * @author Zhiwen Yang
	 * @brief Speeds up cacti and Pteradactyls
	 */
	...
	/**
	 * @author Zhiwen Yang
	 * @brief Checks for collision between character and obstacle parameter a
	 * @param a ImageView object of obstacle
	 */
	...
	/**
	 * @author Zhiwen Yang
	 * @brief releases high-altitude pteradactyl
	 * @param c ImageView of pteradactyl animation
	 */
	...
	/**
	 * @author Zhiwen Yang
	 * @brief releases low-altitude pteradactyl
	 * @param c ImageView of pteradactyl animation
	 */
	...
	/**
	 * @author Zhiwen Yang
	 * @brief Releases cactus
	 * @param c ImageView of Cactus
	 */
	private static void releaseCactus(ImageView c){
		cactusSelected = c;
		cactusPath = new Path();
		...
		cactusTransition.setDuration(Duration.millis(cactusSpeed));
	...
	/**
	 * @author Zhiwen Yang
	 * @brief Stops landscape animation
	 */
	...
	/**
	 * @author Zhiwen Yang
	 * @brief begins animation of ground
	 * @param speed int Speed of groud
	 */
	...
	/**
	 * @author Zhiwen Yang
	 * @brief determines if Character is at ground level
	 * @return boolean whether character is on ground or not
	 */
	...
	/**
	 * @author Shrey Mittal
	 * @brief activated point counting 
	 */
	...
	/**
	 * @author Zhiwen Yang
	 * @brief stops all animations and transitions
	 */
