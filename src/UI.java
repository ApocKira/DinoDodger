...
public class UI extends Application{
	...
	/**
	 * @author Razan Abujarad
	 * @version 1
	 * @brief This class creates the UI of the game. It contains the menu to select the character and landscape, as well as the Gameplay window
	 */
	...
	static Scene playScene = PlayScene.gameModeScene;
	...
	/**
	 * @author Razan Abujarad
	 * @param primaryStage Stage object on which to set scenes containing buttons and animations
	 * @brief This method includes all initialised buttons and messages within the scenes required for this project
	 */
...
//		});
	...
	/**
	 * @author Razan Abujarad
	 * @param e is an ActionEvent which takes mouse input from user
	 * @brief informs system Character 1 is selected
	 */
	 ...
	 * @author Razan Abujarad
	 * @param e is an ActionEvent which takes mouse input from user
	 * @brief informs system Character 2 is selected
	 */	
	 ...
	 * @author Razan Abujarad
	 * @param e is an ActionEvent which takes mouse input from user
	 * @brief informs system Character 3 is selected
	 */
	 ...
	 * @author Razan Abujarad
	 * @param e is an ActionEvent which takes mouse input from user
	 * @brief informs system Landscape 1 is selected
	 */
	 ...
	 * @author Razan Abujarad
	 * @param e is an ActionEvent which takes mouse input from user
	 * @brief informs system Landscape 2 is selected
	 */
	 ...
	 * @author Razan Abujarad
	 * @param e is an ActionEvent which takes mouse input from user
	 * @brief informs system Landscape 3 is selected
	 */
	 ...
	 * @author Razan Abujarad
	 * @param e is an ActionEvent which takes mouse input from user
	 * @brief informs system Play is clicked
	 */
	 ...
	 * @author Razan Abujarad
	 * @param e is an ActionEvent which takes mouse input from user
	 * @brief informs system "Main Menu" is clicked
	 */
	...
	/**
	 * @author Razan Abujarad
	 * @brief Creates third scene to display "GAME OVER" text, score, and options for user
	 */
	...
	/**
	 * @author Razan Abujarad
	 * @brief updates Highscore of user after collision
	 */
